...
<ul>
  <li><a href="azman_kpi.php">HOME</a></li>
  <li class="dropdown">
...
<tr>
  ...
  <td style="width: 100px"><center><b>11.6</b></center></td>
</tr>
<tr>
  <td><b>TOTAL WORKLOAD RESEARCH</b></td>
  <td><center><b>30.1</b></center></td>
</tr>
<tr>
  <td><b>TOTAL WORKLOAD CLINICAL</b></td>
  <td><center><b>1.7</b></center></td>
</tr>
<tr>
...
$con  = mysqli_connect("localhost","root","","kpi system");
 if (!$con) {
    ...
    echo "Problem in database connection! Contact administrator!" . mysqli_error();
         ...
         $sql ="SELECT * FROM chart_column_azman";
...
<html lang="en"> 
    ...
    <body>
        <div style="width:70%;height:50%;text-align:center">
            ...
            <div>LECTURER KPI FOR DR.MD AZMAN</div>
