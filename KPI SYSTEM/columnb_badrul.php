...
<ul>
  <li><a href="badrul_kpi.php">HOME</a></li>
  <li class="dropdown">
...
<tr>
  ...
  <td style="width: 100px"><center><b>10.0%</b></center></td>
</tr>
<tr>
  <td><b>TOTAL WORKLOAD RESEARCH</b></td>
  <td><center><b>19.6%</b></center></td>
</tr>
<tr>
...
$con  = mysqli_connect("localhost","root","","kpi system");
 if (!$con) {
    ...
    echo "Problem in database connection! Contact administrator!" . mysqli_error();
         ...
         $sql ="SELECT * FROM chart_column_badrul";
...
<html lang="en"> 
    ...
    <body>
        <div style="width:70%;height:50%;text-align:center">
            ...
            <div>LECTURER KPI FOR DR.BADRUL</div>
