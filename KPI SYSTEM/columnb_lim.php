...
<ul>
  <li><a href="lim_kpi.php">HOME</a></li>
  <li class="dropdown">
...
<tr>
  ...
  <td style="width: 100px"><center><b>18.5</b></center></td>
</tr>
<tr>
  <td><b>TOTAL WORKLOAD RESEARCH</b></td>
  <td><center><b>66.4</b></center></td>
</tr>
<tr>
...
$con  = mysqli_connect("localhost","root","","kpi system");
 if (!$con) {
    ...
    echo "Problem in database connection! Contact administrator!" . mysqli_error();
         ...
         $sql ="SELECT * FROM chart_column_limvh";
...
<html lang="en"> 
    ...
    <body>
        <div style="width:70%;height:50%;text-align:center">
            ...
            <div>LECTURER KPI FOR DR.LIM VUANGHAO</div>
