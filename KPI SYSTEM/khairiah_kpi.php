...
<ul>
  <li><a class="active" href="khairiah_kpi.php">HOME</a></li>
  <li class="dropdown">
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    <a href="data_khairiah.php">EXCEL DATA(2019-2021)</a>
  </div>
</div>
...
<table border="10">
<tr>
  <td rowspan='5' valign='top '><img src="khai.jpg" width="150" height="203"></td>
 <td style="width:150px;height: 40px"><b>NAME:</b></td>
  <td style="width:600px;height: 40px"><b> DR. NOOR KHAIRIAH BINTI A. KARIM</b></td>
</tr>
<tr>
