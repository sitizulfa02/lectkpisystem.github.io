...
<br>
<ul>
  <li><a href="academic.php">ACADEMIC GRAPH</a></li>
  <li><a class="active" href="sorted_academic.php">ACADEMIC TABLE</a></li>
</ul>
            ...
            <div class="col-md-12">
                <div class="card mt-5">
                    <div class="card-header">
                        <h4>SORT ACADEMIC LECTURER KPI</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php 
                                ...
                                $query = "SELECT * FROM sort_academic ORDER BY percentage $sort_option";
