...
<br>
<ul>
  <li><a href="research.php">RESEARCH GRAPH</a></li>
  <li><a class="active" href="sorted_research.php">RESEARCH TABLE</a></li>
</ul>
            ...
            <div class="col-md-12">
                <div class="card mt-5">
                    <div class="card-header">
                        <h4>SORT RESEARCH LECTURER KPI</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php 
                                ...
                                $query = "SELECT * FROM sort_research ORDER BY percentage $sort_option";
