...
<ul>
  <li><a class="active" href="badrul_kpi.php">HOME</a></li>
  <li class= "dropdown">
    <a href="javascript:void(0)" class="dropbtn">KEY PERFORMANCE INDICATOR(KPI)</a>
    <div class="dropdown-content">
      <a href="linec_badrul.php">Whole Number</a>
      <a href="columnb_badrul.php">Percentage</a>
    </div>
  </li>
</ul>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    <a href="data_badrul.php">EXCEL DATA(2019-2021)</a>
  </div>
</div>
...
<table border="10">
<tr>
  <td rowspan='5' valign='top '><img src="badrulyahaya.png"></td>
  <td style="width:150px;height: 40px"><b>NAME:</b></td>
  <td style="width:600px;height: 40px"><b>ASSOCIATE PROFESSOR DR. BADRUL HISHAM BIN YAHAYA</b></td>
</tr>
<tr>
